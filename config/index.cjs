  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '971E9OboKeFB-H9jMc08b0nlzqberB_zH4Ar-zzcA7w',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'https://live-record-bak.cqoss.xstore.ctyun.cn/record/live/live1/c1c5a34f27b2613acaf3a11914f6eb63.png',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-08-21' }
      ],
      // 课程表相关配置
