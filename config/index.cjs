  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'RGPdvisJOJqkgCkE1zmaPvofWXwSOOU_CSszwj4woSQ',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'http://online-download.gz4oss.xstore.ctyun.cn/model/testmode/ffmpeg/live/test123.mp4',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-07-31' }
      ],
      // 课程表相关配置
