  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'JpQ5k6LLY6brqLMiJaGUnzIKYQC6lOy8a-juldhDSAY',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'http://online-download.gz4oss.xstore.ctyun.cn/model/testmode/ffmpeg/live/love.MP4',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-07-28' }
      ],
      // 课程表相关配置
