  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '-OuDwoAZolcn5zAz4a3Uvsbnc67t5i0A275zGqJNs6w',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'http://online-download.gz4oss.xstore.ctyun.cn/model/testmode/ffmpeg/live/test001001.mp4',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-08-15' }
      ],
      // 课程表相关配置
