  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '9NDrsVapbmQogVOHIpDFQynsYIrYL3_WSCC9TiSblGo',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'hhttp://online-download.gz4oss.xstore.ctyun.cn/ctyunos_base_report/ffmpeg/waterMark.jpg',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-08-27' }
      ],
      // 课程表相关配置
