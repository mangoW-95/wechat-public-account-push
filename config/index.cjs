  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Qawa2CudeJ4IVGYY9YesJXsxf-SB-Qy732v0W4tOuLQ',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'http://online-download.gz4oss.xstore.ctyun.cn/model/testmode/ffmpeg/live/demo2.jpg',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-07-19' }
      ],
      // 课程表相关配置
