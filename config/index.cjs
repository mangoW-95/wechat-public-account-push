  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'IMOu6q-tf0PPyKEjEGe9FPwTYTizP4JXkbhQ38LEtfc',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'http://online-download.gz4oss.xstore.ctyun.cn/model/testmode/ffmpeg/live/test1122.jpg',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-08-10' }
      ],
      // 课程表相关配置
    ...
    },
    {
      ...
      customizedDateList: [
        ...
        { keyword: 'love_day', date: '2023-07-09' },
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-08-13' }
      ],
      // 课程表相关配置
      // 如果courseSchedule不存在或者为空（null）则认为没有课程
      // 如果courseSchedule是一个数组，则认为不区分单双周，直接填写星期几对应的课表数据即可
